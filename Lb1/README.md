...
1. Отримати курс валют із сайту НБУ за попередній тиждень за допомогою Postman. Приклад використання API
   ...
   Для отримання офіційних курсів валют за попередній тиждень було сформовано запит GET  в середовищі Postman із зазначенням дат початку та завершення періоду, коду валюти та формату відповіді JSON. У результаті отримано масив даних з курсами валют за кожен день.
