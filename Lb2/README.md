...
# Завдання
1. [Easy] Встановити python веб фреймворк та запустити веб сервер на порту 8000.Результат виконання:
...
Програмний код для виконання завдання: **[Task2.py](Scripts/task1.py)**
