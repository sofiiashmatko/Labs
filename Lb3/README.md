...
![Скріншот результату виконання запиту](Pictures/Items_added.png)

![Скріншот результату виконання запиту](Pictures/Items_added_result.png)

iii.	PUT для оновлення запису

![Скріншот результату виконання запиту](Pictures/Items_updated.png)

iv.	DELETE для видалення записів 

![Скріншот результату виконання запиту](Pictures/Items_deleted.png)

![Скріншот результату виконання запиту](Pictures/Items_deleted_result.png)
...
7. Протестувати функціональність веб-сервісу за допомогою Postman
   
 ![Скріншот результату](Pictures/Logs.png)

i.	[medium] З використанням бібліотеки requests написати клієнт для веб-сервісу, за допомогою якого можна зчитувати каталог товарів, додавати, оновлювати та видаляти товари з каталогу 
